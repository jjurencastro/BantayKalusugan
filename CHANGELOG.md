...
- Patient health history export

## [1.0.0] - 2026-03-07

### Added
- Initial release of BantayKalusugan Community Health Monitoring Platform
- Patient registration and authentication
- Patient health dashboard with alerts
- Medical assistance request system
- Health incident reporting
- Nurse patient management interface
- Nurse health data update functionality
- Community health monitoring features
- Doctor medical advice and approval system
- Doctor health recommendations
- Barangay admin user account management
- Health and incident report generation
- System security and data integrity features
